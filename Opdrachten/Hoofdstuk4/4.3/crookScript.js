...
crook1.style.Image = "url('IMGCrook/Ogen/crookOgen1.jpg')";
var crook2 = document.getElementById("crook2");
crook2.style.Image = "url('IMGCrook/Neuzen/crookNeus1.jpg')";
var crook3 = document.getElementById("crook3");
crook3.style.Image = "url('IMGCrook/Monden/crookMond1.jpg')";

crook1.addEventListener("click", function() {
    crook1.style.backgroundImage = "url('IMGCrook/Ogen/crookOgen" + getCrookOgen() + ".jpg')";
});
crook2.addEventListener("click", function() {
    crook2.style.backgroundImage = "url('IMGCrook/Neuzen/crookNeus" + getCrookNeus() + ".jpg')";
});
crook3.addEventListener("click", function() {
    crook3.style.backgroundImage = "url('IMGCrook/Monden/crookMond" + getCrookMond() + ".jpg')";
});
