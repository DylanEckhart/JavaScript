...
crook1.style.backgroundImage = "url('IMG/Ogen/crookOgen1.jpg')";
var crook2 = document.getElementById("crook2");
crook2.style.backgroundImage = "url('IMG/Neuzen/crookNeus1.jpg')";
var crook3 = document.getElementById("crook3");
crook3.style.backgroundImage = "url('IMG/Monden/crookMond1.jpg')";
